...
def deployApp() {
    ...
    sshagent(['ec2-jekins']) {
        ...
        sh "scp -o StrictHostKeyChecking=no docker-compose.prod-deploy.yml ${ec2instans}:/home/ubuntu"
        sh "cd jenkins && scp -o StrictHostKeyChecking=no server-cmds.sh ${ec2instans}:/home/ubuntu"
